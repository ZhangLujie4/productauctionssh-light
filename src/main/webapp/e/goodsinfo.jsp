			...
			<div>
				...
				<div class="info">
					...
					<table cellpadding="0" cellspacing="1" border="2" class="grid" width="100%">
						...
						<tr>
							<td style="border-right: 0px;" align="right">税收:</td>
							<td style="border-left: 0px;"><font color="#D23030" style="font-size:20px;"><b><%=goods.getShuishou() %>%</b></font></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td style="border-left: 0px;" width="*"><%if(goods.getStatus().equals("正在拍卖")){ %>距离结束时间:<span id="endtime"><font style="color:yellow;"><%=sjc %></font></span><%} %></td>
						</tr>
						<tr>
							<td colspan="9">
							<%if(member!=null){ %>
							...
							<%} %>
							<%}else{ %>
							<a id="btnIncart" class="btn btn-default" style="display:block;border-radius:5px 5px;" href="login.jsp">竞价 </a>
							<%} %>
							<a id="btnIncart" class="btn btn-default" style="display:block;border-radius:5px 5px;margin: 0px auto;position:absolute;top:653px;left:650px;" href="jingjiarecord.jsp?goodsid=<%=goods.getId() %>">竞价记录</a>
							</td>
