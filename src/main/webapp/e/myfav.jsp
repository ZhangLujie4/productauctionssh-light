						...
						<tbody>
							...
							<tr>
								...
								<td style="padding-top:30px;">
									<%
								    ArrayList<Score> slist = (ArrayList<Score>)dao.findByHql("from Score where memberid='"+member.getId()+"' and saleid='"+goods.getMemberid()+"'");
								    if(slist.size()==0&&goods.getStatus().equals("交易完成")){ 
								    %>
								    <a href="/productauctionssh/e/pingfen.jsp?saleid=<%=goods.getMemberid() %>&gid=<%=goods.getId() %>" class="orange-href">卖家评分</a>
								    <%} %>
