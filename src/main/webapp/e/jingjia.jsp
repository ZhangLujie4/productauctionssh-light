				...
				<input type="hidden" id="hiddenjiajia" value="<%=goods.getJiajia() %>"/>
				  <table border="0" width="100%" align="center">
				    ...
				    <tr>
				      ...
				      <input type="submit" class="orange-button" id="btnReigster" value="竞价" name="btnReigster"   style="display:block;border-radius:5px 5px;margin-right: 90px;background: #A41616">
				      </td>
				    </tr>
				  </table>
				</form>
