...
Member member = (Member)dao.findById(id,"Member");
 %>
           <div class="search-title">
           	...
           	<form name="usersform" method="post" action="mbEdit.action?id=<%=id %>" id="usersForm">
					<table class="grid" cellspacing="1" width="100%">
						...
						<tr>
							...
							<td>
								<input name="upass" required  
									class="input-txt" type="password" id="txtPassword" value="<%=member.getUpass() %>"/>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<input name="email" required 
									class="input-txt" type="text" id="txtEmail" value="<%=member.getEmail() %>"/>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input name="tel" 
									class="input-txt" type="text" id="txtTel" required value="<%=member.getTel()==null?"":member.getTel() %>"/>
							</td>
						</tr>
						<tr>
							<td align="right">
							...
							<td>
								<input name="addr" 
									class="input-txt" type="text" id="txtTel" required value="<%=member.getAddr()==null?"":member.getAddr() %>"/>
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								<input name="realname" 
									class="input-txt" type="text" id="txtRealname" required value="<%=member.getRealname()==null?"":member.getRealname() %>" />
							</td>
						</tr>
					    <tr>	
							<td align="right">
							...
							<td>
								<input name="sex" type="radio"  value="男" <%=member.getSex().equals("男")?"checked=checked":"" %> />男
								<input name="sex" type="radio" value="女" <%=member.getSex().equals("女")?"checked=checked":"" %> />女
							</td>
						</tr>
