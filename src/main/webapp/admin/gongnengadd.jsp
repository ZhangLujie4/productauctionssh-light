...
%>
           <div class="search-title">
           	...
           	<form name="usersform" method="post" action="fatherAdd.action?fatherid=<%=fatherid %>" id="usersForm">
					<table class="grid" cellspacing="1" width="100%" >
						...
						<tr>
							...
							<td width="35%">
								<input name="url" id="url"  validate="{required:true,messages:{required:'url'}}" 
									class="input-txt" type="text" /><div id="errmsg" style="display: none;font-weight: "></div>
							</td>
						</tr>
						<%} %>
