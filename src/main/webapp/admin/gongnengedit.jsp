...
Gongneng g = (Gongneng)dao.findById(id,"Gongneng");
%>
           <div class="search-title">
           	...
           	<form name="usersform" method="post" action="fatherEdit.action?fatherid=<%=fatherid %>&id=<%=id %>" id="usersForm">
					<table class="grid" cellspacing="1" width="100%" >
						<tr>
							...
							<td width="35%">
								<input name="name" id="name"  validate="{required:true,messages:{required:'功能名称'}}" 
									class="input-txt" type="text"  value="<%=g.getName() %>"/><div id="errmsg" style="display: none;font-weight: "></div>
							</td>
						</tr>
						...
						<tr>
							...
							<td width="35%">
								<input name="url" id="url"  value="<%=g.getUrl() %>" validate="{required:true,messages:{required:'url'}}" 
