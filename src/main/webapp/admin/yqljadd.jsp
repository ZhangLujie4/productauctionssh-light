...
<body>
           <div class="search-title">
           	...
           	<form name="usersform" method="post" action="yqljAdd.action" id="usersForm">
					<table class="grid" cellspacing="1" width="100%" >
						<tr>
							...
							<td width="35%">
								<input name="name" id="name"  validate="{required:true,messages:{required:'友情链接名称'}}" 
						...
						<tr>
							...
							<td>
								<input name="url" id="url" class="input-txt" type="text"  validate="{required:true,messages:{required:'友情链接地址'}}" />
							</td>
						</tr>
