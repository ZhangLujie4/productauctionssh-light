...
<body>
           ...
           <div class="search-title">
                ...
                <div class="description">
                    <a href="/productauctionssh/admin/yqljadd.jsp">新增友情链接</a>
                </div>
            </div>
            ...
            <table id="module" width="100%" border="0" cellspacing="0"
						...
						String hql="from Yqlj where 1=1";
						String url="/productauctionssh/admin/yqljlist.jsp?1=1";
						...
						PageManager pageManager = PageManager.getPage(url,10, request);
   	    				...
   	    				ArrayList<Yqlj> list=( ArrayList<Yqlj>)bean.getCollection();
						if(list.size()==0){
						 %>
								<tr>
									<td colspan="20">
							...
							<%}else{ for(Yqlj yqlj:list){%>
								<tr>
									...
									<td>
										<a class="edit" href="yqljedit.jsp?id=<%=yqlj.getId() %>">修改</a>
									</td>
								</tr>
								<% }}%>
...
if(suc!=null){
%>
location.replace("/productauctionssh/admin/yqljlist.jsp");
<%}%>
</script>
</html>