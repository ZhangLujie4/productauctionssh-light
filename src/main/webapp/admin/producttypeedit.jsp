...
<body>
           <div class="search-title">
            ...
            Producttype p = (Producttype)dao.findById(id,"Producttype");
            %>
           	<form name="usersform" method="post" action="producttypeEdit.action?id=<%=id %>" id="usersForm">
					<table class="grid" cellspacing="1" width="100%" >
						<tr>
							...
							<td>
								<input name="typename"  class="input-txt" type="text" id="typename" value="<%=p.getTypename() %>" required/>
							</td>
						</tr>
